...
function NebulaBg() {
  ...
  return (
    <View style={StyleSheet.absoluteFillObject} pointerEvents="none">
      ...
      {/* Nebula blobs (React Native Views — no blur on RN easily, use opacity) */}
      <View style={[S.nebulaBlob, { top: H*0.1, left: -60, backgroundColor: 'rgba(168,85,247,0.18)' }]} />
      <View style={[S.nebulaBlob, { top: H*0.2, left: W*0.15, backgroundColor: 'rgba(236,72,153,0.12)', width:200, height:200 }]} />
      <View style={[S.nebulaBlob, { bottom: H*0.15, right: -60, backgroundColor: 'rgba(59,130,246,0.18)' }]} />
      <View style={[S.nebulaBlob, { bottom: H*0.2, right: W*0.15, backgroundColor: 'rgba(34,211,238,0.12)', width:200, height:200 }]} />
    </View>
  );
}
...
function SpinRing({ size, dur, reverse=false, color='rgba(255,255,255,0.6)', dashed=false }: {
  ...
  return (
    <Animated.View style={{
      ...
      borderWidth: dashed?1.5:2, borderColor:color,
...
export default function LoginScreen() {
  ...
  // Breathe animation for the logo sphere
...
const S = StyleSheet.create({
  ...
  sphereCore:  {
    ...
    backgroundColor:'#000',
    shadowColor:'#a855f7', shadowOffset:{width:0,height:0}, shadowRadius:30, shadowOpacity:0.9,
    elevation:15,
  },
  appName: {
  ...
  googleBtn: {
    ...
    backgroundColor:'#fff', paddingVertical:14, paddingHorizontal:20, borderRadius:18,
  },
  ...
  fbBtn: {
    flexDirection:'row', alignItems:'center', gap:12,
    backgroundColor:'#1877F2', paddingVertical:14, paddingHorizontal:20, borderRadius:18,
  },
  ...
  guestBtn: {
    ...
    shadowColor:'#a855f7', shadowOffset:{width:0,height:0}, shadowRadius:12, shadowOpacity:0.4,
    elevation:6,
  },
  ...
  legalTxt: {
    color:'rgba(168,85,247,0.4)', fontSize:10, textAlign:'center',
